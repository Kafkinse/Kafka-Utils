...
import dev.kafka.kafkautils.module.modules.combat.FastBreak;
import dev.kafka.kafkautils.module.modules.combat.FastEat;
...
import dev.kafka.kafkautils.module.modules.render.EconomyHud;
...
import dev.kafka.kafkautils.module.modules.render.MessengerHud;
...
import dev.kafka.kafkautils.module.modules.render.PotionEffectsHud;
...
public final class ModuleManager {
   ...
   public static void init() {
      ...
      register(new EconomyTracker());
      register(new EconomyHud());
