...
import dev.kafka.kafkautils.module.modules.combat.AutoTrade;
...
import dev.kafka.kafkautils.module.modules.render.TeamOverlay;
...
public final class ModuleManager {
   ...
   public static void init() {
      ...
      register(new TeamOverlay());
      register(new ClanList());
      register(new CoordinateShare());
      register(new ClanChatHighlight());
